...
exports.commands = [
  ...
  require('./commands/ps/restart').kill,
  require('./commands/ps/restart').killDyno,
  require('./commands/ps/restart').killRoot,
  require('./commands/ps/restart').ps,
  require('./commands/ps/restart').root,
  require('./commands/ps/restart').stop,
  require('./commands/ps/restart').stopDyno,
  require('./commands/ps/restart').stopRoot,
